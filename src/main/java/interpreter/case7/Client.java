package interpreter.case7;

import interpreter.case7.AbstractExpression.Expression;
import interpreter.case7.Context.Engineer;
import interpreter.case7.Context.Manager;
...
public class Client {
	...
	public static void main(String[] args) {
		...
		System.out.printf("For '%s', %s: %s.\n", andersen.getEmployeeName(), expression, expression.interpret(andersen));
	}
}
