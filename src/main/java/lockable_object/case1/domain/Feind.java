...
import lockable_object.case1.Lockable;
...
public class Feind implements Runnable {
	 ...
	 */
	private void fightForTheSword(Creature reacher, @NonNull Creature holder, Lockable sword) throws InterruptedException {
